...
class ActorPageParse:
    def __init__(self, actor_id, actor_info_html):
        """
        初始化
        :param actor_id:
        :param actor_info_html:
        """
        self.person_id = actor_id
        self.person_info_html = actor_info_html
