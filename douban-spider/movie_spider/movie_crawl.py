...
from movie_spider.movie_page_parse import MoviePageParse
from movie_spider.movie_actor_page_parse import ActorPageParse
import time
import random
import os
...
class DouBanMovieSpider:
    def __init__(self):
        ...
        # 初始化配置
        try:
            spider_config_file_path = '../movie_spider/movie_spider_config.yaml'
            with open(spider_config_file_path, 'r') as f:
        ...
        # ip代理
        self.proxies = {"http": "http://182.34.37.112:15936"}
        # 请求过期时间
        ...
        while not ip_flag:
            ...
            try:
                ...
                if check_ip_status == 200:
                    self.proxies.clear()
                    self.proxies['http'] = rand_ip.strip('\n')
    ...
    def get_movie_id(self, movie_type='', start=0):
        ...
        movie_id_api = 'https://movie.douban.com/j/new_search_subjects?sort=U&range=0,10&tags=2021&start=' + str(
        ...
        print('length = ' + str(len(movie_id_json)))
    ...
    def get_movie_info(self, movie_id):
        ...
        try:
            ...
            movie_info_file_path = 'movie_info_2021.txt'
    ...
    def get_person_info(self, person_id):
        ...
        try:
            ...
            person_info_html = requests.get(person_url, headers=self.headers, proxies=self.proxies,
                                            timeout=self.timeout).text
            person_page_parse = ActorPageParse(person_id, person_info_html)
            ...
            person_info_file_path = 'movie_actor_info_2021.txt'
