...
处理整个流程
"""
from query.named_entity_recognition.named_entity import QueryNER
...
class Query:
    def __init__(self):
        ...
        # NER初始化加载词
        self.query_ner = QueryNER(['../named_entity_recognition/book_and_movie_name.txt', '../named_entity_recognition/person_name.txt'])
